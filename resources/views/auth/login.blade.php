    ...
    <div class="relative z-10 w-full max-w-sm bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="px-8 py-6 bg-blue-900 relative">
            <div class="flex items-center gap-3">
                <div class="w-11 h-11 rounded-xl flex items-center justify-center text-white font-bold text-lg bg-blue-600">O</div>
                <div>
                    <div class="font-bold text-white text-base">Ormawa Saintek</div>
                    <div class="text-[10px] text-white/60">Portal Administrasi Organisasi Mahasiswa</div>
                </div>
            </div>
        </div>
        ...
        {{-- Body --}}
        <div class="px-8 py-7">
            <h1 class="text-lg font-bold text-slate-900">Masuk ke Akun</h1>
            <p class="text-xs text-slate-400 mb-6">Gunakan kredensial admin Anda untuk melanjutkan</p>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="email" type="email" name="email" value="{{ old('email') }}"
                               ...
                               class="w-full h-11 pl-9 pr-4 text-sm bg-gray-50 border border-gray-200 rounded-lg 
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" type="password" name="password"
                               ...
                               class="w-full h-11 pl-9 pr-10 text-sm bg-gray-50 border border-gray-200 rounded-lg 
                                      focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition">
                        <button type="button" id="togglePw" class="absolute right-3 text-gray-400 hover:text-gray-600 transition">
                            👁
                        </button>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('password.request') }}" class="text-xs text-blue-600 hover:text-blue-800 font-medium">Lupa password?</a>
                </div>
        ...
        <div class="border-t border-gray-100 px-8 py-3.5 text-center text-xs text-gray-400">
            Butuh bantuan? <a href="mailto:ormawa@saintek.ac.id" class="text-blue-600 font-semibold hover:text-blue-800">Hubungi admin</a>
        </div>
    </div>
