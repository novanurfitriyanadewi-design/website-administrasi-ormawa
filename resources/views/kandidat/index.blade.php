        ...
        <table class="min-w-full">
            ...
            @forelse($kandidats as $kandidat)
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="p-3">{{ $kandidat->nim }}</td>
                    <td class="p-3">{{ $kandidat->prodi }}</td>
                    <td class="p-3">{{ $kandidat->organisasi }}</td>
                    <td class="p-3">{{ $kandidat->ipk }}</td>
                    <td class="p-3">{{ Str::limit($kandidat->visi,40) }}</td>
                    <td class="p-3">{{ Str::limit($kandidat->misi,40) }}</td>
                    <td class="p-3">
